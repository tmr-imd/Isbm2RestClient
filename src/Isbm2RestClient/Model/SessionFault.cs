...
namespace Isbm2RestClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SessionFault")]
    public partial class SessionFault : IEquatable<SessionFault>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionFault" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionFault()
        {
        ...
        public SessionFault(string fault = default(string))
        {
            // to ensure "fault" is required (not null)
            if (fault == null)
            {
                throw new ArgumentNullException("fault is a required property for SessionFault and cannot be null");
            }
            this.Fault = fault;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        {
            return this.Equals(input as SessionFault);
        }

        /// <summary>
        /// Returns true if SessionFault instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionFault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionFault input)
        {
            if (input == null)
            {
                return false;
